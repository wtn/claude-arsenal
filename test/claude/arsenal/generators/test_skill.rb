    ...
    module Generators
      class TestSkill < Minitest::Test
        ...
        def test_initialize_with_valid_parameters
          ...
          assert_equal '.claude/skills', skill.output_dir
        end
        ...
        def test_generate_creates_skill_directory
          ...
          assert Dir.exist?('.claude/skills/test-skill')
          assert Dir.exist?('.claude/skills/test-skill/resources')
          assert File.exist?(path)
          assert_equal '.claude/skills/test-skill/SKILL.md', path
        end
